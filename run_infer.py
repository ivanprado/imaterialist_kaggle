...
def run(img_set_folder, model_file, model_class, model_type, set_type, samples_limit=None, tta=False):
  image_dataset, dataloader = get_data_loader(img_set_folder, model_type, set_type, batch_size=6, tta=tta)
...
run(img_set_folder, model_file, model_class, model_type, 'test', samples_limit=None, tta=True)
