...
model_file = None
model_file = "runs/"+ "May29_08-18-20_cs231n-1se_resnext101_38x4d-bs-64-lr0.6-mom0.9-wd1e-5-minscale0.3-rota15-cas-best-classes25-trainval" + "/model_best.pth.tar" # 0.6440, PW1
model_file = "runs/"+ "May29_15-14-04_cs231n-1se_resnext101_38x4d-bs-64-lr0.06-mom0.9-wd1e-5-minscale0.3-rota15-cas-best-classes15-trainval" + "/model_best.pth.tar" # 0.6623, PW1
...
optimizer_ft = optim.SGD(model.parameters_to_train, lr=0.006, momentum=0.9, weight_decay=1e-5) # se_resnext50_32x4d
...
trainer = Trainer("se_resnext101_38x4d-bs-64-lr0.006-mom0.9-wd1e-5-minscale0.3-rota15-cas-best-classes15-trainval",
                  model,
                  criterion,
                  optimizer_ft,
                  exp_lr_scheduler,
