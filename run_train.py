...
#model_file = "runs/"+ "May28_21-27-57_cs231n-1sexception-bs-38-clr0.1-0.01-0.001-mom0.9-wd1e-5-cutout4-minscale0.4-rota15-cas-best-classes25-trainval" + "/model_best.pth.tar" # 0.6621, PW1
#model_file = "runs/"+ "May29_06-04-06_cs231n-1se_resnext50_32x4d-bs-64-clr0.006-0.0006-mom0.9-wd1e-5-scale0.3-0.6-rota15-cas-best-classes25-trainval" + "/model_best.pth.tar" # 0.6631, PW1
#model_file = "runs/"+ "May29_08-18-20_cs231n-1se_resnext101_32x4d-bs-64-lr0.6-mom0.9-wd1e-5-minscale0.3-rota15-cas-best-classes25-trainval" + "/model_best.pth.tar" # 0.6440, PW1
#model_file = "runs/"+ "May29_15-14-04_cs231n-1se_resnext101_32x4d-bs-64-lr0.06-mom0.9-wd1e-5-minscale0.3-rota15-cas-best-classes15-trainval" + "/model_best.pth.tar" # 0.6637, PW1
model_file = "runs/"+ "May29_19-25-32_cs231n-1se_resnext101_32x4d-bs-64-lr0.006-mom0.9-wd1e-5-minscale0.3-rota15-cas-best-classes15-trainval" + "/model_best.pth.tar" # 0.6641, PW1

#model_file = "runs/"+ "May30_15-23-50_cs231n-1se_resnext50_32x4d-bs-64-clr0.06-0.006-mom0.9-wd1e-5-minscale0.3-rota10-ratio0.9-1.1-cas-best-classes15-trainval" + "/model_best.pth.tar" # 0.6620, PW1 lr static to 0.06
#model_file = "runs/"+ "May30_16-09-41_cs231n-1se_resnext50_32x4d-bs-64-lr0.006-mom0.9-wd1e-5-minscale0.3-rota10-ratio0.9-1.1-cas-best-classes15-trainval" + "/model_best.pth.tar" # 0.6636
#model_file = "runs/"+ "May30_18-09-07_cs231n-1se_resnext50_32x4d-bs-64-lr0.0006-mom0.9-wd1e-5-minscale0.3-rota10-ratio0.9-1.1-cas-best-classes10-trainval" + "/model_best.pth.tar" # 0.6628

model_file = "runs/"+ "May30_20-14-59_cs231n-1se_resnext101_32x4d-bs-38-lr0.0006-mom0.9-wd1e-5-minscale0.3-rota10-ratio0.9-1.1-cas-best-classes-15-trainval" + "/model_best.pth.tar" # 0.6642
...
trainer = Trainer("se_resnext101_32x4d-bs-38-lr0.0006-mom0.9-wd1e-5-minscale0.3-rota10-ratio0.9-1.1-cas-best-classes-15-trainval",
                  model,
                  criterion,
                  optimizer_ft,
                  exp_lr_scheduler,
